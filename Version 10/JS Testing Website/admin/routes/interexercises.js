...
// Register
router.get('/createScenario1',  function (req, res) {
    res.render('createScenario1');
});
//code mutation explanation solution
// Register User
router.post('/createScenario1', function (req, res) {
    ...
    console.log(errors);
    if (errors) {
        res.render('createScenario1', {error : errors})
    } else {
        var newInterexercise = new Interexercise({
            code: code,
            mutation: mutation,
        ...
        Interexercise.createInterexercise(newInterexercise, function(err, user){
            if(err) throw err;
            console.log(newInterexercise);
        });
