...
// Register
router.get('/createScenario2',  function (req, res) {
    res.render('createScenario2');
});
//code mutation explanation solution
// Register User
router.post('/createScenario2', function (req, res) {
    ...
    console.log(errors);
    if (errors) {
        res.render('createScenario2', {error : errors})
    } else {
        var newAdvexercise = new Advexercise({
            code: code,
            mutation: mutation,
        ...
        Advexercise.createAdvexercise(newAdvexercise, function(err, user){
            if(err) throw err;
            console.log(newAdvexercise);
        });
